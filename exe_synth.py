...
num_seasons = 32
train_loader, valid_loader = get_dataloader(n_steps, n_features, num_seasons, batch_size=16, missing_ratio=0.1, seed=10, is_test=False, v2=False)
...
filename = "model_diffsaits_synth_qual_final.pth"
...
mse_folder = "results_synth_qual_final"
data_folder = "results_synth_qual_data_final"
lengths = [10, 50, 90]
for l in lengths:
    print(f"\nlength = {l}")
    print(f"\nBlackout:")
