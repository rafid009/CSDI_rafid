...
filename = "model_diffsaits_synth_qual_stable_attn_both_softmax.pth"
...
mse_folder = "results_synth_qual_stable_attn_both_softmax"
data_folder = "results_synth_qual_stable_attn_both_softmax"
lengths = [20, 50, 80]
for l in lengths:
    print(f"\nlength = {l}")
    print(f"\nBlackout:")
